...
VibeMenu._state = {}   -- (reserved for senere bruk)
...
function VibeMenu.Init(opts)
	...
	function inst:SetToggleKey(keycode)
		...
		Hint.Text = ("[%s] to toggle"):format(keyName(self._toggleKey))
	end
